                ...
                <div className="col-md-4">
                    <div className="card border-primary mb-3 pt-3 shadow">
                        <div className="card-body text-primary">
                            <input type="text" className='form-control form-control-lg mb-2 text-center bg-light fs-4 text-primary shadow' value={val} onChange={(e) => setVal(e.target.value)}/>
                            ...
                            <div className="row mt-2">
                                ...
                                <div className="col-3">
                                    <button className="btn btn-light text-primary shadow px-2 py-4" value="c" onClick={() => backspace()}>C/CE</button>
                                </div>
                            </div>
                            <div className="row mt-2">
                                <div className="col-3">
                                ...
                                <div className="col-3">
                                    <button className="btn btn-light text-primary shadow p-4 py-4" value="+" onClick={(e) => setVal(val + e.target.value)}>+</button>
                                </div>
                            </div>
                            <div className="row mt-2">
                                <div className="col-3">
                                ...
                                <div className="col-3">
                                    <button className="btn btn-light text-primary shadow p-4 py-4" value="*" onClick={(e) => setVal(val + e.target.value)}>x</button>
                                </div>
                            </div>
                            <div className="row mt-2">
                                <div className="col-3">
